...
int main()
{
	...
	*/
	...
	string faqq;
	Student Vetrov("Данил", "Братанов", "Михайлович", "adress", "ИиВТ", 2001, 89546721891, 3);
	Smass.push_back(Vetrov);
	kol_vo++;
	Student Chichkanov("Егор", "Мащенко", "Дмитриевич", "adress", "ИиВТ", 2001, 89546721891, 3);
	Smass.push_back(Chichkanov);
	kol_vo++;
	Student Sitnikov("Сергей", "Ситников", "Александрович", "adress", "ИСИТ", 2000, 89546721891, 4);
